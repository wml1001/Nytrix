...
public:
    ...
    //std::string sendRequest(SOCKET sock, const std::string& payload, const char* serverIP);
    void sendRequest(SOCKET sock, const std::string& payload, const char* serverIP,std::string port);
